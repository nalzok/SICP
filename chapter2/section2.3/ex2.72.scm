...
;;
;; Also, the order of growth of number of steps required to encode the very
;; middle frequent symbol is theta of n^2, regardless of how the tree is
;; constructed.
;;
;; In the general case, the order of growth of the number of steps needed to
;; encode a symbol is at least theta of one, and at most theta of n^2, depend-
;; ing on the frequency of the symbol and the shape of the Huffman tree.
