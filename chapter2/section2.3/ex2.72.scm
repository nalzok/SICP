...
;; number of steps needed to encode a symbol is at least theta of one, and at
;; most theta of n^2, depending on the frequency of the symbol, and the shape
;; of the Huffman tree used.
